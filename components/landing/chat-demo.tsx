...
const CONVERSATIONS: Conversation[] = [
  {
    ...
    agentLines: [
      ...
      "**חולשה:** חסרים נתוני יזם/קבלן, מחיר ושלב תכנוני — הציון מבוסס על 4 גורמים בלבד.",
    ],
    scoreCard: {
      score: 69,
      grade: "B",
      factors: [
        { label: "שירותי שכונה", value: "70" },
        { label: "מומנטום עירוני", value: "70" },
        { label: "תחבורה ציבורית", value: "70" },
        { label: "תמיכת רשות", value: "60" },
      ],
    },
  },
  {
